...
public class SmeakySynth extends Chubgraph
{
    LiSa record;
    LiSa play;
    ...
    fun float rateDeviation(float dev)
    {
        dev => m_rateDeviation;
        return m_rateDeviation;
    }
    ...
    fun void go()
    {
        ...
        while(true)
        {
            ...
            if(loopMode == 1) // play
            {
                ...
                spork ~ grain(play, Std.rand2f(250, 600)::ms, 10::ms, 10::ms, rate, playbackPos);
